# GoClay
Source code line by line port of Nick Barkers **_Clay_** library.
For more indepth documentation look at [Clay project page](https://github.com/nicbarker/clay/tree/main/examples).
